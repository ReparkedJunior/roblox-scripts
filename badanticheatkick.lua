...
Title = "copied username successfully",
Time = 4
})
end)
...
tween = tweenService:Create(game:GetService("Players")["LocalPlayer"].Character.HumanoidRootPart, tweenInfo, {CFrame = CFrame.new(0, 9999999, 0)})
tween:Play()
end)
